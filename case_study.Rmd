...
**The Client & Context**
The client is a composite of high-end smart home manufacturers producing control systems, AV, networking, and lighting gear. *(Alex: confirm keeping "composite" or substituting a specific engagement name.)* Because products reach homeowners strictly through thousands of independent, owner-operated custom integration firms, allocating channel budgets accurately is central to their go-to-market strategy.
...
**Deliverables**
Designed for sales executives, buying-group leaders, and trade analysts, the project delivers a one-page executive summary, clear comparative charts, and a presentation deck—backed by a fully audited R Markdown notebook and data-cleaning log for full verification.
